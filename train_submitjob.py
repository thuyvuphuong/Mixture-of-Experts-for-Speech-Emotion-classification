...
parser.add_argument('--top_k', type=int, default=3, help='Top K experts to consider')
...
moes_layer = MoE(input_shape= inputs.shape, num_experts=num_experts,
                 top_k = top_k)
...
# %%
checkpoint_filepath = f'trained_models/model_sp{num_experts}_top{top_k}.keras'
acc_save_path = f'../trained_output/acc_and_loss_sp{num_experts}_top{top_k}.jpg'
cfs_matrix_save_path = f'../trained_output/confusion_matrix_sp{num_experts}_top{top_k}.jpg'
